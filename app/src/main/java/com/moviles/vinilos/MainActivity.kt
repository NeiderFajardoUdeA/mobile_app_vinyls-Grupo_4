...
import com.moviles.vinilos.ui.AlbumFragment

class MainActivity<Fragment> : FragmentActivity() {
                ...
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    ...
                    Box(
                        ...
                        Column(
                            ...
                            Button(
                                onClick = { replaceFragment(AlbumFragment()) },
    ...
    private fun replaceFragment(fragment: AlbumFragment){
